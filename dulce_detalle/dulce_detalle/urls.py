...
urlpatterns = [
    ...
    path('<str:slug>/gestion/', include([
        ...
        path('productos/barras/buscar/', views.buscar_por_barras, name='buscar_por_barras'),
        path('productos/barras/stock/', views.incrementar_stock_barras, name='incrementar_stock_barras'),
    ...
    path('<str:slug>/tienda/', include([
        ...
        path('carrito/api/color/<int:pk>/',   views.carrito_publico_api_color,   name='carrito_api_color'),
        # API Analytics
